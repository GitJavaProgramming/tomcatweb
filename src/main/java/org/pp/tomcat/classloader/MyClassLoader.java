...
public class MyClassLoader extends ClassLoader {
    ...
    private String path = "D:\\IdeaProjects\\tomcatweb\\target\\classes\\";
    ...
    public static void main(String[] args) throws Exception {
        ...
        loader1.setPath("D:\\IdeaProjects\\tomcatweb\\target\\classes\\");
    ...
    private static void loader(MyClassLoader loader) throws Exception {
        ...
        Class test = loader.loadClass("org.pp.tomcat.classloader.Test");
...
// 卸载，将引用置空
        ...
        test = loader.loadClass("org.pp.tomcat.classloader.Test");
